...
void stateMachine::state_machine(const std::vector<GenericObject> &objects, const std::vector<Eigen::Vector2f> &line, rc::Robot &robot){
...
void stateMachine::approach_state(const std::vector<GenericObject> &objects, const std::vector<Eigen::Vector2f> &line, rc::Robot &robot)
{
...
void stateMachine::search_state(const std::vector<GenericObject> &objects, rc::Robot &robot)
{
